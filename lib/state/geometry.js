...
module.exports = function (state, emitter) {
  ...
  function setMesh (name, opts) {
    ...
    /*
    solid.scale[0] = (bbox.max[0]-bbox.min[0])*scale[0]
    solid.scale[1] = (bbox.max[1]-bbox.min[1])*scale[1]
    solid.scale[2] = (bbox.max[2]-bbox.min[2])*scale[2]
    ...
    solid.translate[0] = bbox.min[0]*scale[0] + translate[0]
    solid.translate[1] = bbox.min[1]*scale[1] + translate[1]
    solid.translate[2] = bbox.min[2]*scale[2] + translate[2]
    ...
    solid.rotate[0] = rotate[0]
    solid.rotate[1] = rotate[1]
    solid.rotate[2] = rotate[2]
    box.rotate[0] = rotate[0]
    box.rotate[1] = rotate[1]
    box.rotate[2] = rotate[2]
    */
  }
}
